...
//   const getVolumeIcon = () => {
//     if (volume === 0) {
//       return <FiVolumeX className="w-5 h-5 text-gray-400 hover:text-white hover:scale-110 transition-transform duration-200" />;
//     } else if (volume > 0 && volume <= 0.3) {
//       return <FiVolume className="w-5 h-5 text-gray-400 hover:text-white hover:scale-110 transition-transform duration-200" />;
//     } else if (volume > 0.3 && volume <= 0.6) {
//       return <FiVolume1 className="w-5 h-5 text-gray-400 hover:text-white hover:scale-110 transition-transform duration-200" />;
//     } else {
//       return <FiVolume2 className="w-5 h-5 text-gray-400 hover:text-white hover:scale-110 transition-transform duration-200" />;
//     }
//   };
...
//             showLyrics={false} // Pass showLyrics as false initially (handled by Homepage)
//             setShowLyrics={() => {}} // Placeholder, as state is managed by Homepage
...
//               <div className="relative group">
//                 <MdLyrics
//                   className={`w-6 h-5 cursor-pointer ${activeRightIcon === "lyrics" ? "text-green-500" : "text-gray-400 hover:text-white"} hover:scale-110 transition-transform duration-200`}
//                   onClick={() => {
//                     toggleRightIcon("lyrics");
//                     onToggleLyrics();
//                   }}
//                 />
//                 {activeRightIcon === "lyrics" && (
//                   <span className="absolute bottom-[-8px] left-1/2 transform -translate-x-1/2 w-1 h-1 bg-green-500 rounded-full"></span>
//                 )}
//               </div>
//               <div className="relative group">
      ...
      >
        {isFullScreen ? (
          <MusicPlayerFullScreen
            ...
            repeatMode={repeatMode}
            toggleRepeat={toggleRepeat}
            activeRightIcon={activeRightIcon} // Still passed for other icons
            toggleRightIcon={toggleRightIcon}
