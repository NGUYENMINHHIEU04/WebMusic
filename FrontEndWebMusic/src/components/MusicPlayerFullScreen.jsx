...
//       {isLyricsVisible ? (
//         <Lyrics songTitle={songTitle} lyrics={lyrics} onClose={handleToggleLyrics} />
//       ) : (
//         <>
//           <img src="https://via.placeholder.com/256" alt="Album Cover" className="w-64 h-64 rounded-lg mx-auto mb-8 shadow-xl" />
//           <h2 className="text-2xl font-bold mb-2">SKYTOUR</h2>
//           <p className="text-lg">{songTitle || "Chay Ngay Di - Sky Tour 2019"}</p>
...
//             {isPlaying ? (
//               <FaPause className="w-12 h-12 text-white cursor-pointer hover:scale-110 transition-transform duration-200" onClick={togglePlay} />
//             ) : (
//               <FaPlay className="w-12 h-12 text-white cursor-pointer hover:scale-110 transition-transform duration-200" onClick={togglePlay} />
//             )}
...
//             </div>
//             <button onClick={toggleFullScreen} className="w-6 h-5 text-gray-400 hover:text-white hover:scale-110 transition-transform duration-200">
