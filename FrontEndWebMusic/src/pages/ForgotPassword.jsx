  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-r from-gray-200 to-blue-100">
      <div className="w-[400px] bg-white rounded-3xl shadow-2xl p-8 text-center">
        <h1 className="text-4xl text-green-900 font-bold mb-6">Forgot Password</h1>
        <form>
          ...
          <button
            type="submit"
            className="w-full py-3 c rounded-lg text-white font-semibold text-lg shadow-md hover:bg-green-600 transition-all"
          >
            Reset Password
          </button>
        </form>
